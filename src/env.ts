interface EnvVariables {
    ...
    MYSQL_TABLE_NAME_CUSTOM_INDEX_ASSETS: string;
    MYSQL_TABLE_NAME_INDEX: string;
    MYSQL_TABLE_NAME_INDEX_ASSET: string;
    MYSQL_TABLE_NAME_INDEX_HISTORY: string;
    API_KEY: string;
}
...
export const ENV_VARIABLES: EnvVariables = {
    ...
    MYSQL_TABLE_NAME_CUSTOM_INDEX_ASSETS: process.env.MYSQL_TABLE_NAME_CUSTOM_INDEX_ASSETS ?? "",
    MYSQL_TABLE_NAME_INDEX: process.env.MYSQL_TABLE_NAME_INDEX ?? "",
    MYSQL_TABLE_NAME_INDEX_ASSET: process.env.MYSQL_TABLE_NAME_INDEX_ASSET ?? "",
    MYSQL_TABLE_NAME_INDEX_HISTORY: process.env.MYSQL_TABLE_NAME_INDEX_HISTORY ?? "",
