interface EnvVariables {
    ...
    MYSQL_TABLE_NAME_CUSTOM_INDEX_OVERVIEW: string;
...
export const ENV_VARIABLES: EnvVariables = {
    ...
    MYSQL_TABLE_NAME_CUSTOM_INDEX:
        process.env.MYSQL_TABLE_NAME_CUSTOM_INDEX ?? process.env.NEXT_PUBLIC_MYSQL_TABLE_NAME_CUSTOM_INDEX ?? "",
    MYSQL_TABLE_NAME_CUSTOM_INDEX_OVERVIEW:
        process.env.MYSQL_TABLE_NAME_CUSTOM_INDEX_OVERVIEW ??
        process.env.NEXT_PUBLIC_MYSQL_TABLE_NAME_CUSTOM_INDEX_OVERVIEW ??
        "",
    TABLE_NAME_CUSTOM_INDEX_ASSETS:
        process.env.TABLE_NAME_CUSTOM_INDEX_ASSETS ?? process.env.NEXT_PUBLIC_TABLE_NAME_CUSTOM_INDEX_ASSETS ?? "",
